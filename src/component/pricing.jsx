    ...
    <div>
      <section className="py-41">
        <div className="max-w-177 mx-auto flex flex-col gap-4">
          <h1 className="font-display text-5xl/15 font-bold text-center mx-auto px-20">
            {" "}
            Plan that scale with you
          </h1>
          <p className="text-center text-lg/7 mt-2 px-25">
            No hidden fees. No long-term contracts. Just a professional space to
            do your best work.
          </p>
        </div>
          ...
          <div className="flex gap-5">
            {office.map((item) => (
              <div className="flex flex-col max-w-86 gap-4 border-[#A0ABC0] border rounded bg-white py-6 px-4">
                ...
                <PriceBenefits />
                <button className="bg-black text-white py-3 rounded-lg px-auto font-display">
                  Book a Tour
                </button>
              </div>
            ))}
      ...
      <section className="flex flex-col gap-16 pt-20 pb-30">
        <div className="max-w-177 mx-auto flex flex-col gap-4">
        ...
        <div className="flex gap-5">
          {virtualOffice.map((item) => (
            <div className="flex flex-col gap-4 p-6 bg-white rounded-lg border border-[#A0ABC0]">
              ...
              <PriceBenefits />
              <button className="bg-black text-white py-3 mt-25 rounded-lg px-auto font-display">
                Book a Tour
              </button>
            </div>
          ))}
      ...
      {/* Accordion section */}
      <section className="max-w-160 flex flex-col items-center mx-auto gap-10">
